...
export const MODEL_LIST: ModelConfig[] = [
  ...
  },
  {
    ...
    provider: "openai",
    categoryId: "openai",
    description: "5.6 经济档 Luna（官网 gpt-5.6-luna；高性价比大批量）",
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    pricing: { inputPerMillion: 1.66, outputPerMillion: 9.94 },
  },
  {
    id: "gpt-5.6-terra",
    name: "GPT-5.6 Terra",
    ...
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    pricing: { inputPerMillion: 17.28, outputPerMillion: 103.68 },
  },
  {
    id: "gpt-5.6-sol",
    name: "GPT-5.6 Sol",
    ...
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    pricing: { inputPerMillion: 33.98, outputPerMillion: 169.92 },
  },
  {
    id: "gpt-6-astra",
    name: "GPT-6 Astra",
    provider: "openai",
    categoryId: "openai",
    description: "OpenAI 最新旗舰（官网 gpt-6-astra；复杂推理与编码）",
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    pricing: { inputPerMillion: 84.96, outputPerMillion: 424.8 },
  },
  {
    id: "gpt-image-1-mini",
  ...
  },
  {
    ...
    provider: "openai",
    categoryId: "openai-image",
    description: "旗舰文生图；官方 $5/1M 文本输入 · $30/1M 图像输出，平台按 medium 1024 约 ¥0.49/张",
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    apiKind: "openai-image",
    pricing: { inputPerMillion: 46.8, outputPerMillion: 280.8, perRequestYuan: 0.49 },
  },
  {
    ...
    categoryId: "openai-image",
    description:
      "最新高速文生图（官网 gpt-image-2.5-flare）；官方 $5/1M 文本输入 · $30/1M 图像输出，平台按 medium 1024 约 ¥0.13/张",
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    apiKind: "openai-image",
    pricing: { inputPerMillion: 46.8, outputPerMillion: 280.8, perRequestYuan: 0.13 },
  },
  {
    ...
    categoryId: "openai-image",
    description:
      "最新精细编辑文生图（官网 gpt-image-2.5-sunburst）；官方 $5/1M 文本输入 · $30/1M 图像输出，平台按 medium 1024 约 ¥0.13/张",
    baseUrl: "https://api.openai.com/v1",
    enabled: true,
    apiKind: "openai-image",
    pricing: { inputPerMillion: 46.8, outputPerMillion: 280.8, perRequestYuan: 0.13 },
  ...
  },
  {
    ...
    provider: "google",
    categoryId: "google",
    description: "3.6 Flash（官网 gemini-3.6-flash；2026 年引入价至 12-31）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    pricing: { inputPerMillion: 6.48, outputPerMillion: 32.4 },
  },
  {
    id: "gemini-3.7-flash",
    ...
    provider: "google",
    categoryId: "google",
    description: "3.7 Flash（官网 gemini-3.7-flash；日常编码与多步 Agent）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    pricing: { inputPerMillion: 6.48, outputPerMillion: 32.4 },
  },
  {
    ...
    provider: "google",
    categoryId: "google",
    description: "3.8 Flash 最新主力（官网 gemini-3.8-flash；长程工程与复杂 Agent）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    pricing: { inputPerMillion: 6.37, outputPerMillion: 31.86 },
  },
  {
  ...
  },
  {
    ...
    provider: "google",
    categoryId: "google-image",
    description: "3.1 Flash 图像稳定版（Nano Banana 2）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    apiKind: "gemini-image",
    pricing: { inputPerMillion: 0, outputPerMillion: 0, perRequestYuan: 0.63 },
  },
  {
    ...
    categoryId: "google-image",
    description:
      "3.1 Flash Lite 图像（官网 gemini-3.1-flash-lite-image / Nano Banana 2 Lite）；官方约 $0.0336/张 1K，平台约 ¥0.31/张",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    apiKind: "gemini-image",
    pricing: { inputPerMillion: 0, outputPerMillion: 0, perRequestYuan: 0.31 },
  },
  {
    ...
    provider: "google",
    categoryId: "google-image",
    description: "已下架；Google 已于 2026-08-17 停用，请改用 gemini-3.1-flash-image",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: false,
    apiKind: "imagen",
    pricing: { inputPerMillion: 0, outputPerMillion: 0, perRequestYuan: 0.37 },
  ...
  },
  {
    ...
    description: "已下架；Google 已于 2026-06-30 停用，请改用 veo-3.1-generate-preview",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: false,
    apiKind: "veo",
  ...
  },
  {
    ...
    provider: "google",
    categoryId: "google-video",
    description: "已下架；Google 已于 2026-06-30 停用，请改用 veo-3.1-fast-generate-preview",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: false,
    apiKind: "veo",
  ...
  },
  {
    ...
    provider: "google",
    categoryId: "google-video",
    description: "Veo 3.1 标准预览（官网约 $0.40/秒，平台按 8 秒约 ¥29.95/次）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    apiKind: "veo",
    pricing: { inputPerMillion: 0, outputPerMillion: 0, perRequestYuan: 29.95 },
  },
  {
    ...
    provider: "google",
    categoryId: "google-video",
    description: "Veo 3.1 快速预览（官网约 $0.10/秒，平台按 8 秒约 ¥7.49/次）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    apiKind: "veo",
    pricing: { inputPerMillion: 0, outputPerMillion: 0, perRequestYuan: 7.49 },
  },
  {
    ...
    provider: "google",
    categoryId: "google-video",
    description: "Veo 3.1 轻量预览（官网约 $0.05/秒，平台按 8 秒约 ¥3.74/次）",
    baseUrl: "https://generativelanguage.googleapis.com/v1beta",
    enabled: true,
    apiKind: "veo",
  ...
  },
  {
    ...
    categoryId: "deepseek",
    description:
      "DeepSeek-V4.1-Flash 主力（官网 deepseek-flash；1M 上下文，含思考/非思考；价按高峰档）",
    baseUrl: "https://api.deepseek.com/v1",
    enabled: true,
    pricing: { inputPerMillion: 2.48, outputPerMillion: 9.94 },
  },
  {
    id: "deepseek-v4-flash",
    name: "DeepSeek V4 Flash（兼容）",
    provider: "deepseek",
    categoryId: "deepseek",
    description:
      "兼容旧 ID：上游已切到 DeepSeek-V4.1-Flash，计费同 deepseek-flash；新接入请用 deepseek-flash",
    baseUrl: "https://api.deepseek.com/v1",
    enabled: true,
  ...
  },
  {
    ...
    provider: "deepseek",
    categoryId: "deepseek",
    description: "V4 Pro（官网 deepseek-v4-pro；1M 上下文，旗舰推理；价按高峰档）",
    baseUrl: "https://api.deepseek.com/v1",
    enabled: true,
    pricing: { inputPerMillion: 11.21, outputPerMillion: 33.64 },
  },
  {
    id: "deepseek-chat",
    ...
    provider: "deepseek",
    categoryId: "deepseek",
    description: "已停用：请改用 deepseek-flash（厂商于 2026-07-24 UTC 下线旧 ID）",
    baseUrl: "https://api.deepseek.com/v1",
    enabled: false,
    pricing: { inputPerMillion: 2.48, outputPerMillion: 9.94 },
  },
  {
    ...
    provider: "deepseek",
    categoryId: "deepseek",
    description: "已停用：请改用 deepseek-flash 思考模式或 deepseek-v4-pro",
    baseUrl: "https://api.deepseek.com/v1",
    enabled: false,
    pricing: { inputPerMillion: 2.48, outputPerMillion: 9.94 },
  },
